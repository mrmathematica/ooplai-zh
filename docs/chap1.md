...
对面向对象编程语言的探索从我们于
PLAI（[《编程语言：应用和解释》](https://lotuc.org/PLAI-cn)）中所学到的、以及对
于什么是对象的直觉开始。
...
请注意 counter 如何使用 cmd 来区分要执行的操作。
...
我们的简单对象系统就足以展示面向对象编程的基本特性：动态分发。请注意，在下面的代
...
我们不再假设在对象的方法表中会有消息关联的方法，而是首先查找并将结果绑定到
